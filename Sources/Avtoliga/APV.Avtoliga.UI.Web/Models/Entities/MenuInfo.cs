...
{
    public sealed class MenuInfo : BaseInfo
    {
                    ...
                    Items = new[]
                        {
                            ...
                            new MenuInfo { Title = "Скачать прайс", Url = "~/price/" },
                        }
                },
                new MenuInfo
                    {
